...
interface CombinatorSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  options: NameLabelList
  rules?: Rule[]
}

interface FieldSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  options: NameLabelList
}

interface OperatorSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  field?: string
  options: NameLabelList
}

interface ValueEditorCustomControlProps
  extends SelectorEditorCustomControlProps {
  field?: string
  operator?: string
}
...
interface QueryBuilderProps {
  ...
  controlElements?: {
    ...
    combinatorSelector?: React.ComponentType<
   ...
   * @param dataType
   */
  getOperators?(dataType: string): Field[]
  /**
