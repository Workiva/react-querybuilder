...
describe('<Rule />', () => {
  ...
  describe('field selector as <ValueSelector />', () => {
    ...
    it('should have options set to expected fields', () => {
      ...
      expect(dom.find('ValueSelector').props().options).to.equal(
        expected_fields
      )
    })
  ...
  describe('value editor as <ValueEditor />', () => {
    ...
    it('should have operator set to selected operator', () => {
      ...
      expect(dom.find('ValueEditor').props().operator).to.equal(
        'selected_operator'
      )
    })
  ...
  describe('rule remove action as <ActionElement />', () => {
    ...
    it('should have the default className', () => {
      const dom = shallow(<Rule {...props} />)
      expect(dom.find('ActionElement').props().className).to.contain(
        'rule-remove'
      )
    })
    ...
    it('should have the onChange method handler', () => {
      ...
      expect(dom.find('ActionElement').props().handleOnClick).to.be.a(
        'function'
      )
    })
  ...
  function behavesLikeASelector(value, defaultClassName, customClassName) {
    ...
    it('should have the default className', () => {
      const dom = shallow(<Rule {...props} />)
      expect(dom.find('ValueSelector').props().className).to.contain(
        defaultClassName
      )
    })
    ...
    it('should have the onChange method handler', () => {
      const dom = shallow(<Rule {...props} />)
      expect(dom.find('ValueSelector').props().handleOnChange).to.be.a(
        'function'
      )
    })
